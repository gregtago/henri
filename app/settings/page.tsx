      ...
      <div className="flex-1 overflow-y-auto">
        <div className={"max-w-4xl mx-auto px-6 py-8 space-y-6"}>
          ...
          {tab === "versions" && (
            <div className="space-y-4">
              {[
                { v: "Alpha 1.5", date: "Juillet 2026", items: ["Modèles de dossier : enregistrez la liste de tâches d'un dossier sous un nom et réutilisez-la", "Appliquez un modèle à un nouveau dossier (bouton 📋) ou à un dossier existant (« Appliquer un modèle »)", "Gérez vos modèles : renommer, supprimer"] },
