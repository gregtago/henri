      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div className={"max-w-4xl mx-auto px-6 py-8 space-y-6"}>
          ...
          {tab === "versions" && (
            <div className="space-y-4">
              {[
                { v: "Alpha 1.7", date: "Juillet 2026", items: ["Mobile — Ma journée : mémos et tâches ont désormais la même ligne (case à cocher à gauche) ; la tâche garde son filet d'avancement et une croix pour la retirer de la journée", "Mobile — cocher un mémo le fait disparaître : il est réalisé. Un lien discret en bas de liste rouvre les mémos réalisés (pour les consulter, les décocher ou les supprimer)", "Mobile — cocher une tâche demande où elle en est, puis la retire de Ma journée : elle reste dans son dossier avec son nouveau statut", "Mobile — un mémo se crée et se modifie dans le même écran : mêmes champs, même disposition (étoile, échéance, rappel, dossier, répétition, observations)", "Rattacher un mémo à un dossier ne le transforme plus en tâche : il garde sa case à cocher et s'affiche sous les tâches du dossier", "Un mémo sans dossier s'efface définitivement au bout de 7 jours — un pense-bête n'est pas une archive"] },
