 ...
 *
 * Elle vaut sur téléphone autant que sur grand écran : c'est même là que le
 * pavé de texte coûtait le plus cher, et là qu'on ouvre le plus souvent les
 * Préférences pour la première fois. Elle s'y touche seulement plus large.
 */
 ...
 * tactile lui prend — 34 px sous un doigt, 30 px sous un curseur, qui vise au
 * pixel.
 */
    ...
    <>
      {label ? (
        ...
        <button
          ...
          title={title}
          className="group shrink-0 inline-flex items-center justify-center w-[34px] h-[34px] md:w-[30px] md:h-[30px] -m-[8px] md:-m-[6px] bg-transparent border-none p-0 cursor-pointer"
        >
