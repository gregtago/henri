...
//
// Ce fichier ne contient **que du calcul** : pas de Firestore, pas de React.
// C'est ce qui lui permet d'être lu aussi bien par l'application que par une
// route d'API (la capture depuis l'iPhone arme les mêmes rappels que la ligne
// de saisie — elle ne peut le faire qu'en appelant les mêmes fonctions).
// La lecture et l'écriture du réglage, elles, vivent dans `reminderPolicy.ts`.
